...
INSERT into offer (title, job_description, type_of_contract, mission, seeked_profile, complementary_info, user_id, company_id)
VALUES ("Developer FullStack", "Un job super dans une entreprise trop bien", "CDI", "Participer au développement de l'entreprise sur la partie tech", "Si vous avez un bac+5 dans le domaine de la tech, venez chez nous !", "Tickets restaurant", 4, 1),
("Developer FrontEnd", "Un job super dans une entreprise trop bien", "CDD", "Participer au développement de l'entreprise sur la partie tech", "Si vous avez un bac+5 dans le domaine de la tech, venez chez nous !", "Tickets restaurant", 4, 1),
("Data Analyst", "Un job super dans une entreprise trop bien", "CDD", "Participer au développement de l'entreprise sur la partie tech", "Si vous avez un bac+45 dans le domaine de la tech, venez chez nous !", "Tickets restaurant", 4, 1),
("Data Analyst", "Un job super dans une entreprise trop bien", "CDI", "Participer au développement de l'entreprise sur la partie tech", "Si vous avez une expérience dans le domaine de la tech, venez chez nous !", "Tickets restaurant, Formations adaptés, babyfoot", 5, 2),
("Data Engineer", "Un job super dans une entreprise trop bien", "CDI", "Participer au développement de l'entreprise sur la partie tech", "Si vous avez une expérience dans le domaine de la tech, venez chez nous !", "Tickets restaurant, Formations adaptés, babyfoot", 5, 2),
("Teaching Assistant - Web Developper", "Un job super dans une entreprise trop bien", "CDD", "Participer au développement de l'entreprise sur la partie tech", "Vous avez déjà réalisé une de nos formations pour débutant ou un équivalent? Vous avez dans l'idée de vouloir évoluer tout en apprenant aux autres? Alors pourquoi ne pas devenir Teaching Assistant?", "Tickets restaurant, Formations adaptés, babyfoot", 5, 2),
("Teaching Assistant - UX/UI Designer", "Un job super dans une entreprise trop bien", "CDI", "Participer au développement de l'entreprise sur la partie tech", "Vous avez déjà réalisé une de nos formations pour débutant ou un équivalent? Vous avez dans l'idée de vouloir évoluer tout en apprenant aux autres? Alors pourquoi ne pas devenir Teaching Assistant?", "Tickets restaurant, Formations adaptés, babyfoot", 5, 2),
("Teaching Assistant - Data Analyst", "Un job super dans une entreprise trop bien", "CDD", "Participer au développement de l'entreprise sur la partie tech", "Vous avez déjà réalisé une de nos formations pour débutant ou un équivalent? Vous avez dans l'idée de vouloir évoluer tout en apprenant aux autres? Alors pourquoi ne pas devenir Teaching Assistant?", "Tickets restaurant, Formations adaptés, babyfoot", 5, 2);

...
("Data Analyst", "Un job super dans une entreprise trop bien", "CDD", "28K", "horaires classiques", "Marseille", "Participer au développement de l'entreprise sur la partie tech", "Si vous avez un bac+45 dans le domaine de la tech, venez chez nous !", "Tickets restaurant", 4, 1),
("Data Analyst", "Un job super dans une entreprise trop bien", "CDI", "31K", "horaires classiques", "Lille", "Participer au développement de l'entreprise sur la partie tech", "Si vous avez une expérience dans le domaine de la tech, venez chez nous !", "Tickets restaurant, Formations adaptés, babyfoot", 5, 2),
("Data Engineer", "Un job super dans une entreprise trop bien", "CDI", "28 à 32K selon expérience", "horaires classiques","Paris", "Participer au développement de l'entreprise sur la partie tech", "Si vous avez une expérience dans le domaine de la tech, venez chez nous !", "Tickets restaurant, Formations adaptés, babyfoot", 5, 2),
